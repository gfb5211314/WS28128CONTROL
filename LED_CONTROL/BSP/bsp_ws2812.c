...
//
    ...
    if(reset_flag==1)
    {
        ...
        HAL_TIM_PWM_Stop_DMA(&HTIM, CHANAL);
...
//    __HAL_RCC_DMA1_CLK_DISABLE();
    ...
    reset_flag = 1;
    HAL_TIM_PWM_Start_DMA(&HTIM, CHANAL, (uint32_t*)ws28128_reset_buf, reset_max);
...
//    __HAL_RCC_DMA1_CLK_DISABLE();
    ...
    light_flag = 1;
    light_led_count = 1;
    HAL_TIM_PWM_Start_DMA(&HTIM, CHANAL, (uint32_t*)ws28128_color_data, 48);
}
...
//    __HAL_RCC_DMA1_CLK_DISABLE();
    ...
    HAL_TIM_PWM_Start_DMA(&HTIM, CHANAL, (uint32_t*)ws28128_mie_buf, 48);
}
/**********单种颜色数据渐变的值*****************/
